...
The Naive-dynamic approach\ignore{, presented by Aynaud et al. \cite{com-aynaud10},} is a simple method for detecting communities in dynamic networks. In this approach, vertices are assigned to communities based on the previous snapshot of the graph, and all vertices are processed, regardless of the edge deletions and insertions in the batch update\ignore{(hence the term \textit{naive})}.
