...
% Applications of CD: studying twitter communities during the 2022 war in Ukraine \cite{sliwa2024case}, reconstructing multi-step cyber attacks \cite{zang2023attack}, defending against Distributed Denial of Service (DDoS) \cite{zhao2024ddos}, developing cyber resilient systems/networks by investigating cyber defense techniques \cite{chernikova2022cyber}, analyzing linguistic variation in memes \cite{zhou2023social}, 
